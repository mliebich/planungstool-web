...
export const DEFAULT_TILES: TileConfig[] = [
	...
	{ id: "import", route: "/kalender-import", icon: "📥", title: "Import", description: "ICS-Datei", color: "#32ADE6", enabled: true, order: 7 },
	{ id: "colors", route: "/farben", icon: "🎨", title: "Farben", description: "Klassen", color: "#FF2D55", enabled: true, order: 8 },
	{ id: "coaching", route: "/coaching", icon: "💬", title: "Coaching", description: "Gespräche", color: "#FF6B6B", enabled: true, order: 9 },
	{ id: "settings", route: "/einstellungen", icon: "⚙️", title: "Einstellungen", description: "Konfiguration", color: "#8E8E93", enabled: true, order: 10 },
];
